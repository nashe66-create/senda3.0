...
function statusConfig(status: string): { bg: string; text: string; label: string } {
  const map: Record<string, { bg: string; text: string; label: string }> = {
    ...
    confirming: { bg: Colors.warning[50], text: Colors.warning[700], label: 'Confirming' },
    confirming_unknown: { bg: Colors.warning[50], text: Colors.warning[700], label: 'Needs verification' },
    reconciliation_required: { bg: Colors.warning[50], text: Colors.warning[700], label: 'Under review' },
    resolution: { bg: Colors.warning[50], text: Colors.warning[700], label: 'Support review' },
